...
package io.github.thierrysquirrel.limiter.aspect;
...
import io.github.thierrysquirrel.limiter.core.utils.AspectUtils;
import lombok.Data;
...
public class LimiterAspect implements ApplicationContextAware {
    ...
    @Pointcut("@annotation(io.github.thierrysquirrel.limiter.annotation.LimitTraffic)")
    public void limitTrafficPointcut() {
        log.debug ("Start LimitTraffic");
    }

    @Pointcut("@annotation(io.github.thierrysquirrel.limiter.annotation.LimitedService)")
